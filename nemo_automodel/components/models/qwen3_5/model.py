    ...
    def prepare_model_inputs_for_cp(
        ...
        *full* (unsharded) sequence; context-parallel sharding then happens on the
        ...
        if pixel_values is not None:
            ...
            image_embeds = self._encode_vision_for_cp(pixel_values, image_grid_thw, is_video=False)
        ...
        if pixel_values_videos is not None:
            ...
            video_embeds = self._encode_vision_for_cp(pixel_values_videos, video_grid_thw, is_video=True)
